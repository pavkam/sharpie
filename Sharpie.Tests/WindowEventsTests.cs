...
public class WindowEventsTests
{
    ...
    {
        _cursesMock = new();
        _window = new(_cursesMock.Object, null, new(1));
        _source = new();
    }
    ...
    [TestMethod]
    public void ProcessEvents_ProcessesTerminalResizeEvents()
    {
        ...
        ((TerminalResizeEvent) e).Size.ShouldBe(new(5, 6));
    }
    ...
    public void ProcessEvents_SkipsInvalidMouseEvents()
    {
        ...
        _cursesMock.Setup(s => s.getmouse(out It.Ref<RawMouseEvent>.IsAny))
                   .Returns((out RawMouseEvent me) =>
                   {
                       ...
                       me = new()
                       {
                           x = dx + 5, y = dx + 6, buttonState = (ulong) RawMouseEvent.EventType.ReportPosition | 0x100
                       };
    ...
    public void ProcessEvents_SkipsMouseEvents_WithBadButtons()
    {
        ...
        _cursesMock.Setup(s => s.getmouse(out It.Ref<RawMouseEvent>.IsAny))
                   .Returns((out RawMouseEvent me) =>
                   {
                       me = new()
                       {
                           buttonState = skip ? 0 : (ulong)RawMouseEvent.EventType.Button2Released
                       };
    ...
    public void ProcessEvents_ProcessesMouseActionEvents()
    {
        _cursesMock.Setup(s => s.getmouse(out It.Ref<RawMouseEvent>.IsAny))
                   .Returns((out RawMouseEvent me) =>
                   {
                       me = new()
                       {
                           x = 5, y = 6, buttonState = (ulong) RawMouseEvent.EventType.Button1Clicked |  (ulong) RawMouseEvent.EventType.Alt
                       };
