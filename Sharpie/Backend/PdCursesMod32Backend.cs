...
internal class PdCursesMod32Backend: PdCursesBackend
{
    ...
    public override bool is_immedok(IntPtr window) => CursesSymbolResolver.Resolve<PdCursesMod32FunctionMap.is_immedok>()(window);

    public override bool is_scrollok(IntPtr window) => CursesSymbolResolver.Resolve<PdCursesMod32FunctionMap.is_scrollok>()(window);
