...
public static class Line
{
    ...
    private static readonly Dictionary<SideAndStyle, Rune> BoxCharacters = new()
    {
        ...
        { SideAndStyle.LeftLight | SideAndStyle.TopHeavy, new('┚') },
        { SideAndStyle.LeftLight | SideAndStyle.TopDouble, new('╜') },
        { SideAndStyle.LeftLight | SideAndStyle.BottomHeavy, new('┒') },
        { SideAndStyle.LeftLight | SideAndStyle.BottomDouble, new('╖') },
        { SideAndStyle.RightLight | SideAndStyle.TopHeavy, new('┖') },
        { SideAndStyle.RightLight | SideAndStyle.TopDouble, new('╙') },
        { SideAndStyle.RightLight | SideAndStyle.BottomHeavy, new('┎') },
        { SideAndStyle.RightLight | SideAndStyle.BottomDouble, new('╓') },
        { SideAndStyle.TopLight | SideAndStyle.LeftHeavy, new('┙') },
        { SideAndStyle.TopLight | SideAndStyle.LeftDouble, new('╛') },
        { SideAndStyle.TopLight | SideAndStyle.RightHeavy, new('┕') },
        { SideAndStyle.TopLight | SideAndStyle.RightDouble, new('╘') },
        { SideAndStyle.BottomLight | SideAndStyle.LeftHeavy, new('┑') },
        { SideAndStyle.BottomLight | SideAndStyle.LeftDouble, new('╕') },
        { SideAndStyle.BottomLight | SideAndStyle.RightHeavy, new('┍') },
        { SideAndStyle.BottomLight | SideAndStyle.RightDouble, new('╒') },
        ...
        { SideAndStyle.LeftLight | SideAndStyle.RightLight | SideAndStyle.TopHeavy | SideAndStyle.BottomHeavy, new('╂') },
        { SideAndStyle.LeftLight | SideAndStyle.RightLight | SideAndStyle.TopDouble | SideAndStyle.BottomDouble, new('╫') },
        { SideAndStyle.TopLight | SideAndStyle.BottomLight | SideAndStyle.LeftHeavy | SideAndStyle.RightHeavy, new('┿') },
        { SideAndStyle.TopLight | SideAndStyle.BottomLight | SideAndStyle.LeftDouble | SideAndStyle.RightDouble, new('╪') },
        { SideAndStyle.LeftLight | SideAndStyle.TopLight | SideAndStyle.RightHeavy | SideAndStyle.BottomHeavy, new('╆') },
        { SideAndStyle.LeftLight | SideAndStyle.BottomLight | SideAndStyle.RightHeavy | SideAndStyle.TopHeavy, new('╄') },
        { SideAndStyle.RightLight | SideAndStyle.TopLight | SideAndStyle.LeftHeavy | SideAndStyle.BottomHeavy, new('╅') },
        { SideAndStyle.RightLight | SideAndStyle.BottomLight | SideAndStyle.LeftHeavy | SideAndStyle.TopHeavy, new('╃') },
